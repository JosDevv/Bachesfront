...
import {loadTable} from './mainForm.js';
  ...
  function showUserEditBox(id) {
    ...
    xhttp.open("GET", "http://localhost:8080/bachestpi2022/resources/tipoobjeto/findId?id="+id);
    xhttp.send();
    xhttp.onreadystatechange = function() {
      if (this.readyState == 4 && this.status == 200) {
        ...
        Swal.fire({
          title: 'Edit User',
          html:
         '<input id="activo" value="'+user['activo']+'" class="swal2-input" placeholder="true">' +
  ...
  function userEdit(id) {
    ...
    const xhttp = new XMLHttpRequest();
    xhttp.open("PUT", "http://localhost:8080/bachestpi2022/resources/tipoobjeto");
