...
function userDelete(id) {
    ...
    xhttp.open("DELETE", "http://localhost:8080/bachestpi2022/resources/tipoobjeto/"+id);
    ...
    xhttp.onreadystatechange = function() {
      if ((this.status >= 200 && this.status<300) ){
        ...
        Swal.fire("El tipo objeto que desea eliminar esta ligado a la tabla de objeto");
      }
    };
  }
