...
import {
  ...
  //4.
  export class autoestado extends LitElement {
      ...
      switch (ev.key) {
        ...
        default:
          ...
          if (idEstado.value === "") {
            ...
            console.log("https://62a3ee1f259aba8e10dfb62b.mockapi.io/estado/" + idEstado.value);
            obtenerJSON("https://62a3ee1f259aba8e10dfb62b.mockapi.io/estado/" + idEstado.value)
              .then((json) => {
  ...
  //51.
  window.customElements.define("auto-estado", autoestado);