...
class formularioInicial extends HTMLElement {
    ...
    if (datos===""){
      ...
      xhttp.open("GET", "http://localhost:8080/bachestpi2022/resources/ruta");
      xhttp.send();
      ...
      xhttp.onreadystatechange = function() {
        if (this.readyState == 4 && this.status == 200) {
          ...
          for (let object of objects) {
            ...
            trHTML += '<td><my-button-edit id="a" label="Edit" valueid='+object['idRuta']+'></my-button-edit>';
            trHTML += '<my-button-del label="Del" valueid='+object['idRuta']+'></my-button-del></td>';
            trHTML += "</tr>";
          }
